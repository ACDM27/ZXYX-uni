  ...
  <view class="form-container">
    <view class="form-content">
      <view class="form-item">
        <text class="label required">论文名称</text>
        <input 
          class="input" 
      ...
      <view class="form-item">
        <text class="label required">论文题目</text>
        <input 
          class="input" 
      ...
      <view class="form-item">
        <text class="label required">期刊名称</text>
        <input 
          class="input" 
      ...
      <view class="form-item">
        <text class="label required">期刊级别</text>
        <picker 
          class="picker" 
          mode="selector" 
          :range="journalLevels" 
        ...
        >
          <view class="picker-text" :class="{ empty: !formData.level }">
            {{ formData.level || '请选择期刊级别' }}
          </view>
        </picker>
      </view>

      <view class="form-item">
        <text class="label required">发表时间</text>
        <picker 
          class="picker" 
          mode="date" 
          :value="formData.date" 
        ...
        >
          <view class="picker-text" :class="{ empty: !formData.date }">
            {{ formData.date || '请选择发表时间' }}
          </view>
        </picker>
      </view>

      <view class="form-item">
        <text class="label required">作者排序</text>
        <picker 
          class="picker" 
          mode="selector" 
          :range="authorOrders" 
          ...
          :value="orderIndex"
        >
          <view class="picker-text" :class="{ empty: !formData.authorOrder }">
            {{ formData.authorOrder || '请选择作者排序' }}
          </view>
        </picker>
      </view>
      
      <view class="form-item">
        <text class="label required">论文摘要</text>
        <textarea 
          class="textarea" 
      ...
      <view class="form-item">
        <text class="label required">论文文件</text>
...
export default {
  data() {
    return {
      ...
      levelIndex: -1,
      orderIndex: -1,
      journalLevels: ['SCI', 'EI', 'CSSCI', 'CSCD', '核心期刊', '普通期刊'],
      authorOrders: ['第一作者', '第二作者', '第三作者', '通讯作者'],
      studentSearch: '',
      teacherSearch: '',
      students: [],
      teachers: [],
  ...
  methods: {
    handleLevelChange(e) {
      ...
      this.formData.level = this.journalLevels[index]
    },
    handleOrderChange(e) {
      const index = e.detail.value
      this.orderIndex = index
      this.formData.authorOrder = this.authorOrders[index]
    },
    handleDateChange(e) {
